	...
	do
	{
		...
		switch (choice)
		{
	     ...
	     case 2:
		    ...
		    break;
		case 3:
			cout<<"Enter value to insert after(1st enter existing value then enter new value): ";
			cin>>existing;
			cin>>val;
			list.insertafter(existing,val);
		     break;
	    case 4:
			cout<<"Enter value to insert before(1st enter existing value then enter new value): ";
			cin>>existing;
			cin>>val;
